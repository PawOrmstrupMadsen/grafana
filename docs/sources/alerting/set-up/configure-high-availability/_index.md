...
| Metric                                                                                             | Description                                                                                                |
| -------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| `alertmanager_cluster_messages_publish_failures_total{msg_type="update",reason="buffer_overflow"}` | Number of broadcast messages dropped due to a full message queue. A non-zero value indicates message loss. |
| `alertmanager_cluster_messages_publish_failures_total{msg_type="update",reason="redis_issue"}`     | Number of broadcast messages that failed due to a Redis error.                                             |
| `alertmanager_cluster_messages_sent_total{msg_type="update"}`                                      | Number of broadcast messages sent to Redis.                                                                |
